...
type GreetServiceClient interface {
	...
	GreetWithDealine(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error)
}
...
func (c *greetServiceClient) SumNumbers(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
	err := c.cc.Invoke(ctx, "/greet.GreetService/SumNumbers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greetServiceClient) GreetWithDealine(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	out := new(GreetResponse)
...
type GreetServiceServer interface {
	...
	GreetWithDealine(context.Context, *GreetRequest) (*GreetResponse, error)
...
func (UnimplementedGreetServiceServer) GreetWithDealine(context.Context, *GreetRequest) (*GreetResponse, error) {
...
func _GreetService_SumNumbers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SumRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreetServiceServer).SumNumbers(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/SumNumbers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).SumNumbers(ctx, req.(*SumRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _GreetService_GreetWithDealine_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreetServiceServer).GreetWithDealine(ctx, req.(*GreetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
